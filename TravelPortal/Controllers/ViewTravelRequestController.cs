...
{
    public class ViewTravelRequestController : Controller
    {
        private readonly IConfiguration _configuration;

        public ViewTravelRequestController(IConfiguration configuration)
        {
        ...
        public ActionResult ViewTravelRequest(string requestToken)
        {
